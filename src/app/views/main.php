    ...
    <div class="container-fluid p-0">
        <div class="row">
            <div class="col-12 position-relative">
                ...
                <img src="/src/public/resources/Main.png" class="img-fluid w-100" alt="메인 이미지" style="max-height: 100vh; object-fit: cover; position: relative; top: -20px; margin-top:20px;">
