...
?>
<head>
    <script type="text/javascript" src="/src/public/js/bootstrap.bundle.js"></script>
    <link rel="stylesheet" href="/src/public/css/bootstrap.css">
</head>
<body>
...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid">
        <a class="navbar-brand" href="/index.php">
            <img src="/src/public/resources/Logo.png" alt="LOGO" width="130px" height="auto">
        </a>
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item mt-2">
                    <a class="btn btn-light btn-sm" aria-current="page" href="/index.php?controller=user&action=problem">문제</a>
                </li>
                <li class="nav-item mt-2">
