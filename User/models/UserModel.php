...
#User Authentication,session
    class UserModel{
        ...
        public function JwtDecryptSymmetricKey($encryptedKey) {
            $privateKey = openssl_pkey_get_private(file_get_contents('User/config/private_key1.pem'));
        ...
        public function JwtSignatureAuth($signedData, $signature) {
            $publicKey = file_get_contents('User/config/public_key.pem');
